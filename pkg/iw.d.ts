...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_2229: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_2227: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_2135: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_2124: (a: number, b: number) => void;
