...
function __wasm_bindgen_func_elem_2229(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_2229(arg0, arg1, addHeapObject(arg2));
}
...
const WebLoaderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_webloader_free(ptr >>> 0, 1));

export class WebLoader {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WebLoaderFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webloader_free(ptr, 0);
    }
    /**
     * @returns {boolean}
     */
    all_files_loaded() {
        const ret = wasm.webloader_all_files_loaded(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {string} file
    ...
    load(file, data) {
        ...
        wasm.webloader_load(this.__wbg_ptr, ptr0, len0, ptr1, len1);
    }
}
if (Symbol.dispose) WebLoader.prototype[Symbol.dispose] = WebLoader.prototype.free;

/**
 * @param {number} ix
 * @returns {any}
 */
export function gamepal_color(ix) {
    const ret = wasm.gamepal_color(ix);
 ...
 */
export function iw_start_web(loader) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(loader, WebLoader);
        var ptr0 = loader.__destroy_into_raw();
        wasm.iw_start_web(retptr, ptr0);
 ...
 * @returns {any}
 */
export function load_gamedata_headers(buffer) {
    try {
        const ret = wasm.load_gamedata_headers(addBorrowedObject(buffer));
        return takeObject(ret);
    } finally {
 ...
 * @param {any} map_headers_js
 * @param {any} map_offsets_js
 * @param {number} mapnum
 * @returns {any}
 */
export function load_map(map_data_js, map_headers_js, map_offsets_js, mapnum) {
    try {
        const ret = wasm.load_map(addBorrowedObject(map_data_js), addBorrowedObject(map_headers_js), addBorrowedObject(map_offsets_js), mapnum);
        return takeObject(ret);
    } finally {
        heap[stack_pointer++] = undefined;
        heap[stack_pointer++] = undefined;
...
/**
 * @param {any} buffer
 * @param {any} offsets_js
 * @returns {any}
 */
export function load_map_headers(buffer, offsets_js) {
    try {
        const ret = wasm.load_map_headers(addBorrowedObject(buffer), addBorrowedObject(offsets_js));
        return takeObject(ret);
    } finally {
        heap[stack_pointer++] = undefined;
        heap[stack_pointer++] = undefined;
 ...
 * @returns {any}
 */
export function load_map_offsets(buffer) {
    try {
        const ret = wasm.load_map_offsets(addBorrowedObject(buffer));
        return takeObject(ret);
    } finally {
        heap[stack_pointer++] = undefined;
    }
...
/**
 * @param {any} gamedata_js
 * @param {any} header_js
 * @returns {any}
 */
export function load_texture(gamedata_js, header_js) {
    try {
        const ret = wasm.load_texture(addBorrowedObject(gamedata_js), addBorrowedObject(header_js));
        return takeObject(ret);
    } finally {
        heap[stack_pointer++] = undefined;
        heap[stack_pointer++] = undefined;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_buffer_469fa3d5a2b8dc1f = function(arg0) {
        const ret = getObject(arg0).buffer;
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_byteOffset_586fecdab746b98e = function(arg0) {
    ...
    imports.wbg.__wbg_length_3a9ea264629fc6b3 = function(arg0) {
        const ret = getObject(arg0).length;
        return ret;
    };
    ...
    imports.wbg.__wbg_set_number_of_outputs_947f730ae0915dcb = function(arg0, arg1) {
        getObject(arg0).numberOfOutputs = arg1 >>> 0;
    };
    imports.wbg.__wbg_set_output_channel_count_231e5fa9fe6e8e16 = function(arg0, arg1) {
    ...
    imports.wbg.__wbindgen_cast_2e5ee46a5eefb571 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 5, function: Function { arguments: [], shim_idx: 36, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_441, __wasm_bindgen_func_elem_481);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_cast_9801e431cbb956c4 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 283, function: Function { arguments: [NamedExternref("Event")], shim_idx: 285, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
        const ret = makeClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_2124, __wasm_bindgen_func_elem_2135);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_cast_ab5e70805db541a2 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 5, function: Function { arguments: [NamedExternref("Event")], shim_idx: 35, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_441, __wasm_bindgen_func_elem_482);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_cast_d5ca15f17e6a1a85 = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_2227, __wasm_bindgen_func_elem_2229);
        return addHeapObject(ret);
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('iw_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
