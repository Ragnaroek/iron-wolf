use super::{new_fixed, new_fixed_raw_u32};
...
fn test_new_fixed() {
    ...
    assert_eq!(new_fixed_raw_u32(0xFF9E_1D73u32).0, 0xFF9E_1D73u32 as i32)
}
...
fn test_print_fixed() {
    ...
    assert_eq!(format!("{}", new_fixed(-98,7539)), "-98.7539");
    assert_eq!(format!("{}", new_fixed_raw_u32(0xFF9E_1D73u32)), "-98.7539");
}