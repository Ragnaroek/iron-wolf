...
use crate::act2::{
    spawn_boss, spawn_dead_guard, spawn_fake_hitler, spawn_fat, spawn_ghosts, spawn_gift,
    spawn_gretel, spawn_hitler, spawn_patrol, spawn_schabbs, spawn_stand,
};
use crate::agent::{
    ...
    for y in 0..MAP_SIZE {
        for x in 0..MAP_SIZE {
            ...
            match tile {
                ...
                179 => {
                    spawn_fat(map_data, &mut actors, actor_at, game_state, x, y);
                }
                180..=183 => {
