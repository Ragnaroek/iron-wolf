...
use super::{fixed_by_frac, new_fixed_i32, new_fixed, new_fixed_u32, new_fixed_i16};
...
fn test_fixed_by_frac() {
    ...
    assert_eq!(fixed_by_frac(new_fixed_i32(14000), new_fixed_i32(-2147418113)), new_fixed_i32(-13999));
}
